...
{
	var xml = '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="procedures_hat_when_run_clicked" x="-1" y="-1"><next><block type="control_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="math_number"><field name="NUM">0</field></block></value><value name="B"><block type="math_number"><field name="NUM">0</field></block></value></block></value></block></next></block></xml>';
	var expected = '// hat\nif (0 == 0) {\n}\n';
...
{
	var xml_text = '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="procedures_hat_when_run_clicked" x="26" y="59"><next><block type="control_if"><value name="IF0"><block type="logic_compare"><field name="OP">EQ</field><value name="A"><block type="math_number"><field name="NUM">0</field></block></value><value name="B"><block type="math_number"><field name="NUM">0</field></block></value></block></value></block></next></block></xml>';
	importXML(xml_text);

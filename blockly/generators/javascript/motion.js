...
Blockly.JavaScript['motion_gotoXY'] = function(block) {
    ...
    if(downloadingCode){
      ...
      code = 'gotoXY(sprite, ' + value_new_x_val + ', ' + value_new_y_val * -1 + ');\n';
    }
    return code;
};
...
Blockly.JavaScript['motion_glideto'] = function(block) {
    ...
    if(downloadingCode){
      ...
      code = 'glideTo(sprite, '+ value_time + ',' + value_x_val + ',' + (value_y_val *-1) +')\n;';
    }
    return code;
};
...
Blockly.JavaScript['motion_changey'] = function(block) {
    ...
    if(downloadingCode){
      ...
      code = 'changeY(sprite, ' + value_change_num * -1 + ');\n';
    }
    return code;
};
...
Blockly.JavaScript['motion_sety'] = function(block) {
    ...
    if(downloadingCode){
      ...
      code = 'setY(sprite, ' + value_new_val*-1 + ');\n';
    }
    return code;
};
